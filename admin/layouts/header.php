...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/project1/public/bootstrap-5.3.2/bootstrap-5.3.2/dist/css/bootstrap.css">
        <script src="/project1/public/bootstrap-5.3.2/bootstrap-5.3.2/dist/js/bootstrap.js"></script>
    </head>
    <body>
                                ...
                                <ul class="collapse show nav flex-column ms-1"
                                    ...
                                    <li class="w-100">
                                        <a href="#" class="nav-link px-0"> <span
                                                class="d-none d-sm-inline">Item</span>
                                            1 </a>
                                    </li>
                                    <li>
                                        <a href="#" class="nav-link px-0"> <span
